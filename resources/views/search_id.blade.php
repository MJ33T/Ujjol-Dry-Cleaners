                ...
                <div class="col-md-6">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Invoice Search (ID)</h3>
                        </div>
                        <form action="search_id" method="POST">
                            ...
                            <div class="card-body" style="height: 200px;" >
                                <div class="row">
                                    ...
                                    <input name="customer_invoice" type="text" class="form-control form-control-lg" required placeholder="Customer Invoice No">
                                </div>
                            </div>
