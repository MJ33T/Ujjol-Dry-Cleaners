    ...
    <table style="width: 100%">
        ...
        <tbody>
            ...
            <tr>
                ...
                @endphp
                <td style="text-align: center">{{$numto->bnNum($pro['iron_worker_rate'])}}</td>
                <td style="text-align: center">{{$numto->bnNum($result[3]*$pro['iron_worker_rate'])}}</td>
                @php
                    $in_total = $result[3]*$pro['iron_worker_rate'] + $in_total;
                @endphp
                @endif    
                @endfor
            </tr>    
